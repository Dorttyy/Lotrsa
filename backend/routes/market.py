...
# --------------------------------------------------------------------------- #
STORE_PRODUCTS = [
    {"id": "sp_tshirt", "name": "【🔥 Promo】 Mello Official Language Learner T-Shirt", "price": 24.99, "category": "Apparel", "sizes": ["S", "M", "L", "XL", "2XL", "3XL"], "image": "https://images.pexels.com/photos/8532616/pexels-photo-8532616.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", "desc": "Soft 100% cotton tee with the multilingual Hello print."},
    ...
    {"id": "sp_cap", "name": "Mello Classic Cap — Embroidered Logo", "price": 15.99, "category": "Apparel", "sizes": [], "image": "https://images.unsplash.com/photo-1588850561407-ed78c282e89b?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2Njl8MHwxfHNlYXJjaHwxfHxjYXB8ZW58MHx8fHwxNzg1NDM2NjAwfDA&ixlib=rb-4.1.0&q=85", "desc": "One size fits all, adjustable strap."},
